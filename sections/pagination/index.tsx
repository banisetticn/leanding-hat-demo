...
const Pagination = () => {
  ...
  return (
    <section className='lh_blog_pagination lh_pagination_section'>
      <div className='container'>
        <div className='lh_pagination_section__area'>
          <div className='lh_pagination'>
            <button className='lh_pagination_prev'>
              <svg
                width='24'
                height='16'
                viewBox='0 0 24 16'
            ...
            <div className='lh_pagination_number'>
              {filters &&
                Array.from(Array(filters?.total_pages as number).keys()).map(
                  (paginumber: number, index: number) => (
                    <button
                      key={`pagination-item-${paginumber}-${index}`}
                      className={`pagination_num ${
                        index + 1 === filters.current_page && 'active_num'
                      }`}
                    >
                      {paginumber + 1}
                    </button>
            ...
            <button className='lh_pagination_next'>
              <svg
                width='24'
                height='16'
                viewBox='0 0 24 16'
